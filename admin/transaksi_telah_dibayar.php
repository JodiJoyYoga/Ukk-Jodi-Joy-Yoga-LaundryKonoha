...
<div class="container-fluid">
    <div class="row bg-title">
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
            <ol class="breadcrumb">
                <li><a href="cetak.php?id=<?=$_GET['id']?>" class="btn btn-danger" style="color:#fff;"><i class="fa fa-file-text fa-fw" aria-hidden="true"></i>Cetak</a></li>
            </ol>
        </div>
        <!-- /.col-lg-12 -->
    </div>
            ...
            <div class="white-box">
                ...
                <div class="row">
                    <div class="col-md-12 text-center">
                        ...
                        <a href="transaksi.php" class="btn btn-primary">Kembali Ke Menu Utama</a><br>
                    </div>
                </div>
