        ...
        <nav class="navbar navbar-default navbar-static-top m-b-0">
            <div class="navbar-header">
                <div class="top-left-part">
                    <!-- Logo -->
                    <a class="profile-pic" href="index.php" ><img src="../assets/plugins/images/utility-room.png" alt="user-img" width="36" class="img-circle" style="color:#54667a">
                        <!-- Logo icon image, you can use font-icon also -->
                        <b class="hidden-xs" style="color:#54667a; font-size:16px;">
                            Laundry Konoha
                        </b>
                ...
                <ul class="nav navbar-top-links navbar-right pull-right">
                    ...
                    <li>
                        <a class="profile-pic" href="#"> <img src="../assets/plugins/images/users/kasir.jpg" alt="user-img" width="36" class="img-circle"><b class="hidden-xs">KASIR</b></a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-header -->
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav slimscrollsidebar">
                ...
                <div class="center p-20">
                     <a href="logout.php" class="btn btn-danger btn-block waves-effect waves-light"><i class="fa fa-power-off fa-fw" aria-hidden="true"></i>Logout</a>
                 </div>
            </div>
