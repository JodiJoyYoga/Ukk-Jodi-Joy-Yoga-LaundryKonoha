                        ...
                        <tbody>
                            <?php $no=1; foreach($data as $transaksi): ?>
                                <tr>
                                    ...
                                    <td align="center">
                                          <a href="transaksi_bayar.php?id=<?= htmlspecialchars($transaksi['id_transaksi']); ?>" data-toggle="tooltip" data-placement="bottom" title="Pilih" class="btn btn-primary btn-block">Pilih</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
